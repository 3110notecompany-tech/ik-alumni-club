...
import tokutenImg from "@/app/[locale]/supporters/tokuten.jpg";
import houjinImg from "@/app/[locale]/supporters/houjin.png";
import puratinaImg from "@/app/[locale]/supporters/puratina.png";
                ...
                <div className="md:w-3/5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {benefit.plans.map((plan) => (
                      <span
                        key={plan}
                        className={`inline-block px-3 py-1.5 rounded-lg text-white font-bold text-sm ${getPlanColor(
                          plan
                        )}`}
                      >
                        {plan}
